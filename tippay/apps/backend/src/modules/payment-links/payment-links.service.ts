...
export class PaymentLinksService {
  ...
  async createPaymentLink(userId: string, dto: CreatePaymentLinkDto) {
    ...
    return {
      ...
      role: paymentLink.role,
      workplace: paymentLink.workplace,
  ...
  async resolvePaymentLink(shortCodeOrId: string) {
    ...
    return {
      ...
      providerName: paymentLink.provider.displayName || paymentLink.provider.user.name,
      role: paymentLink.role,
      workplace: paymentLink.workplace,
      avatarUrl: paymentLink.provider.avatarUrl,
      bio: paymentLink.provider.bio,
